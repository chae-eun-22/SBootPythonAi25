...
class LoggingMiddleware(BaseHTTPMiddleware): # 로그를 콘솔에 출력하는 용도 1usage
    logging.basicConfig(level=logging.INFO) # 로그를 출력 추가
...
@app.get("/items/{item_id") # http://ip 주소:포트/items/1
